...
- Likelihood
$L(\pi) = \binom{n}{k} \pi^k(1-\pi)^{n-x}$ for $\pi \in (0,1)$
...
- Likelihood:
$P(data|\pi) = \binom{n}{k} \pi^k(1-\pi)^{n-x}$ 
$P(data|\pi) \propto \pi^k(1-\pi)^{n-x}$
- Beta prior: $Beta(a,b)$
$P(\pi) \propto \pi^{\alpha-1}(1-\pi)^{\beta-1}$
- Posterior: 
$P(\pi|data) \propto \pi^k(1-\pi)^{n-x}\pi^{\alpha-1}(1-\pi)^{\beta-1}$
$P(\pi|data) \propto \pi^{k+\alpha-1}(1-\pi)^{n-x+\beta-1}$
